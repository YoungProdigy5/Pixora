...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    function createWallpaperCard(item) {
        ...
        /*
         * Build the card with DOM elements instead of
         * inserting the title as raw HTML. This prevents
         * malformed database content from creating visual
         * elements over the first wallpaper title.
         */
     ...
     * It runs when the search icon is tapped
     * while the search panel is open, or when
     * Enter is pressed inside the search box.
     */
    function performSearch() {
        ...
        if (query) {
            ...
            /*
             * Send the user to the wallpaper results.
             * "wallpaperGrid" is the actual results
             * container, so this also works if the
    ...
    /*
     * First tap opens search.
     * If already open, tapping the same search
     * control executes the search.
     */
    ...
    /*
     * Live filtering remains enabled.
     */
